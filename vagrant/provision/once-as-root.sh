...
apt-get update
apt-get install -y git ruby2.0 php7.0-curl php7.0-cli php7.0-intl php7.0-zip php7.0-mysqlnd php7.0-gd php7.0-mbstring php7.0-fpm nginx mysql-server-5.6  php-memcached memcached
